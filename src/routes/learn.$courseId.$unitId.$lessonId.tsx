...
function Content({ block }: { block: ContentBlock }) {
  switch (block.type) {
    case "heading": return <h2 className="mt-8 font-display text-h3 text-foreground">{block.text}</h2>;
